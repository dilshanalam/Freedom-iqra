...
<head>
  ...
  <title>Purnea College, BCA HONS 1st Year 2023-2024 All Subject Notes</title>
  ...
  <style>
    ...
    .button {
      ...
      cursor: pointer;
      color: #ffffff; /* White text color for better clarity */
      background-color: #ffffff; /* Green button color */
      border: 2px solid #000000; /* Dark green border */
      border-radius: 5px;
      transition: background-color 0.3s, transform 0.2s;
      box-shadow: 0 4px 8px rgba(126, 122, 122, 0.1); /* Soft shadow */
    }

    .button:hover {
      background-color: #080808; /* Dark green on hover */
